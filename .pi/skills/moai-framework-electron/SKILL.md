...
Changes: Restructured to comply with AGENTS.md or MoAI loaded context Documentation Standards - removed all code examples, converted to narrative text format
