...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash(npm:*), Bash(npx:*), Bash(firebase:*), Bash(curl:*), configured Pi web/fetch skill, configured Pi web/search skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
