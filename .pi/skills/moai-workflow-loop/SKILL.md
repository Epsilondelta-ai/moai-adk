...
- Hook System: PostToolUse and Stop hooks for seamless Pi/MoAI runtime integration
...
The PostToolUse hook is triggered after Write and Edit operations. When invoked, Pi/MoAI runtime provides hook input containing the tool_name (such as Write) and tool_input containing the file_path and content.
...
The LSP hook is located at .pi/ or .moai runtime resources converted from .claude/hooks/moai/post_tool__lsp_diagnostic.

The loop hook is located at .pi/ or .moai runtime resources converted from .claude/hooks/moai/stop__loop_controller.
...
Status: Active
Integration: Pi/MoAI runtime Hooks, LSP Protocol, AST-grep
