# Pi/MoAI runtime Skills Formatting Guide

Complete formatting reference for creating Pi/MoAI runtime Skills that comply with official standards and best practices.
...
allowed-tools: Read, Grep, Glob, configured Pi web/fetch skill

# WRONG: YAML array format
allowed-tools: [Read, Grep, Glob]

# WRONG: Overly permissive
allowed-tools: Read, Write, Edit, Bash, Grep, Glob, configured Pi web/fetch skill, MultiEdit
```
...
Pi/MoAI runtime Version Compatibility:
- Document compatible Pi/MoAI runtime versions
- Test with latest Pi/MoAI runtime release
