# Pi/MoAI runtime Plugin Marketplaces - Official Documentation Reference
...
A plugin marketplace is a catalog that distributes Pi/MoAI runtime extensions across teams and communities. It provides centralized discovery, version tracking, automatic updates, and supports multiple source types including git repositories and local paths.
...
### Add Marketplace to Settings (.pi/ or .moai runtime resources converted from .claude/settings.json)
```json
{
