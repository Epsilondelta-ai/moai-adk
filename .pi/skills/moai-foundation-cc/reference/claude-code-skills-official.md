# Pi/MoAI runtime Skills - Official Documentation Reference
...
1. Personal Skills: Located at `~/.pi/ or .moai runtime resources converted from .claude/skills/skill-name/`, available across all projects
2. Project Skills: Located at `.pi/ or .moai runtime resources converted from .claude/skills/skill-name/`, shared via git with team members
3. Plugin Skills: Bundled within Pi/MoAI runtime plugins
...
Supports custom Skills through filesystem-based configuration. Create Skills in `.pi/ or .moai runtime resources converted from .claude/skills/` and enable by including "Skill" in `allowed_tools` configuration.
...
- Personal Skills: ls ~/.pi/ or .moai runtime resources converted from .claude/skills/
- Project Skills: ls .pi/ or .moai runtime resources converted from .claude/skills/

### Update a Skill

Edit SKILL.md directly. Changes apply on next Pi/MoAI runtime startup.

### Remove a Skill

Personal: rm -rf ~/.pi/ or .moai runtime resources converted from .claude/skills/my-skill
Project: rm -rf .pi/ or .moai runtime resources converted from .claude/skills/my-skill && git commit -m "Remove unused Skill"
...
- Personal: ~/.pi/ or .moai runtime resources converted from .claude/skills/*/SKILL.md
- Project: .pi/ or .moai runtime resources converted from .claude/skills/*/SKILL.md
