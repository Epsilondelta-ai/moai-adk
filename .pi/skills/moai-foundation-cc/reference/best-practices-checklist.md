# Pi/MoAI runtime Skills Best Practices Checklist

Comprehensive checklist for creating, validating, and maintaining Pi/MoAI runtime Skills that comply with official standards and deliver maximum value to users.
...
Standards Research:
- [ ] Reviewed latest Pi/MoAI runtime official documentation
...
Pi/MoAI runtime Version:
- [ ] Compatible with current Pi/MoAI runtime version
...
- [ ] Official Pi/MoAI runtime standards followed
...
```bash
# YAML syntax validation
yamllint .pi/ or .moai runtime resources converted from .claude/skills/skill-name/SKILL.md

# Link checking
markdown-link-check .pi/ or .moai runtime resources converted from .claude/skills/skill-name/

# Line count verification
wc -l .pi/ or .moai runtime resources converted from .claude/skills/skill-name/SKILL.md
```
