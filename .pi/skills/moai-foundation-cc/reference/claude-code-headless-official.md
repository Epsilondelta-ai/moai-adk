# Pi/MoAI runtime Headless Mode - Official Documentation Reference
...
Headless mode allows programmatic interaction with Pi/MoAI runtime without an interactive terminal interface. This enables CI/CD integration, automated workflows, and script-based usage.
...
Warning: This removes Pi/MoAI runtime capabilities. Use --append-system-prompt instead unless you have specific requirements.
...
Adds instructions while preserving Pi/MoAI runtime functionality.
...
Prefer --append-system-prompt over --system-prompt to retain Pi/MoAI runtime capabilities.
