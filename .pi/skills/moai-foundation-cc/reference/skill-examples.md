# Pi/MoAI runtime Skills Examples Collection

Comprehensive collection of real-world skill examples covering various domains and complexity levels, all following official Pi/MoAI runtime standards.

Purpose: Practical examples and templates for skill creation
Target: Skill developers and Pi/MoAI runtime users
...
allowed-tools: Read, Write, Edit, Grep, Glob, configured Pi web/fetch skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
version: 1.2.0
...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash, configured Pi web/fetch skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
version: 1.2.0
...
allowed-tools: Read, Write, Edit, Bash, Grep, Glob, configured Pi web/fetch skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
version: 1.1.0
