# Pi/MoAI runtime Complete Configuration Guide
...
```json
{
 ...
 "configured Pi web/fetch skill": ["domain:*.company.com"] // Approved domains only
 },
 "mcpServers": {
...
## Pi/MoAI runtime Settings

### Settings Hierarchy

Configuration Priority (highest to lowest):
1. Enterprise Settings: Organization-wide policies
2. User Settings: `~/.pi/ or .moai runtime resources converted from .claude/settings.json` (personal)
3. Project Settings: `.pi/ or .moai runtime resources converted from .claude/settings.json` (shared)
