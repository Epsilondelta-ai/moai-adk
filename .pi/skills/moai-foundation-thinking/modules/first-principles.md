...
Handling: Use moai_ask_user to clarify which are truly negotiable.
...
Use moai_ask_user to explore which directions are viable given constraints.

## Integration with moai_ask_user

When decomposing problems:
- Use moai_ask_user to verify understanding of the problem
- Use moai_ask_user to explore why certain constraints exist
- Use moai_ask_user to confirm root cause identification
- Use moai_ask_user to validate decomposition completeness
