...
2. Use moai_ask_user to understand user priorities
...
- Use moai_ask_user to confirm criterion weights match priorities
- Use moai_ask_user to present options with scores
- Use moai_ask_user to validate trade-off acceptability
- Use moai_ask_user to explore sensitivity to different weights

Example moai_ask_user for Trade-off Confirmation:
