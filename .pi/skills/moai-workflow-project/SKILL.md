...
allowed-tools: Read, Write, Edit, Bash(git:*), Bash(npm:*), Bash(npx:*), Bash(uv:*), Bash(pip:*), Bash(ls:*), Bash(mkdir:*), Grep, Glob, configured Pi web/fetch skill, configured Pi web/search skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
...
Purpose: Comprehensive project management system that integrates documentation generation, multilingual support, and template optimization into unified architecture with intelligent automation and Pi/MoAI runtime integration.
...
Target: Pi/MoAI runtime agents for project setup, documentation generation, multilingual support, and performance optimization.
...
- moai-foundation-cc: Pi/MoAI runtime integration and configuration
...
- configured Pi web/fetch skill / configured Pi web/search skill: Latest online documentation
...
3. configured Pi web/search skill + configured Pi web/fetch skill (latest online resources)
