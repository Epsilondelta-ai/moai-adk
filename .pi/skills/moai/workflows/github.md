...
- No argument: moai_ask_user to choose
...
- Otherwise: Display list via moai_ask_user, let user select
...
- Otherwise: moai_ask_user to select
...
Present review summary to user via moai_ask_user:
