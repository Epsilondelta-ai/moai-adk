...
- Each coverage gap tracked as a pending task via moai_task_create
- Before test generation: change to in_progress via moai_task_update
...
9. moai_task_create/moai_task_update for all gaps and generated tests
