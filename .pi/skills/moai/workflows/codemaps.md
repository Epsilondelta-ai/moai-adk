...
- Each map file creation tracked as a pending task via moai_task_create
- Before each generation: change to in_progress via moai_task_update
- After each generation: change to completed via moai_task_update
...
6. moai_task_create/moai_task_update for all generated files
