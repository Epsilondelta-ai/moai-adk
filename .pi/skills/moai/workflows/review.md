...
Present options via moai_ask_user:
...
- Create fix tasks: Create moai_task_list items for each finding so they can be addressed individually. Useful for team coordination.
...
- Each critical finding tracked as a pending task via moai_task_create
