...
For tag types, lifecycle rules, mandatory fields, and per-file limits, see: .pi/ or .moai runtime resources converted from .claude/rules/moai/workflow/mx-tag-protocol.md
