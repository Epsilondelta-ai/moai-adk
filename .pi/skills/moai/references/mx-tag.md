...
For tag types, trigger conditions, lifecycle rules, when to add/update/remove tags, per-file limits, mandatory fields, and language settings, see the authoritative source: .pi/ or .moai runtime resources converted from .claude/rules/moai/workflow/mx-tag-protocol.md
