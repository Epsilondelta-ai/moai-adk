...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash(npm:*), Bash(npx:*), Bash(docker:*), Bash(git:*), configured Pi web/fetch skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
metadata:
  version: "2.0.0"
  category: "platform"
  status: "active"
