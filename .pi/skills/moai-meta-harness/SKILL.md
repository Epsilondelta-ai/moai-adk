...
description: >
  ...
  my-harness-* skills + .pi/ or .moai runtime resources converted from .claude/agents/my-harness/* + .moai/harness/* artifacts.
license: Apache-2.0
compatibility: Designed for Pi/MoAI runtime (v2.1.111+)
...
- AGENTS.md or MoAI loaded context contains `<!-- moai:harness-start -->` markers (installed by
...
| Agent definitions | `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/*.md` | this skill |
| Domain skills | `.pi/ or .moai runtime resources converted from .claude/skills/my-harness-*/SKILL.md` | this skill |
...
| 5. Customization | Phase 4 skill generation | meta-harness (this skill) | Skeleton | `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/*.md` + `.pi/ or .moai runtime resources converted from .claude/skills/my-harness-*/SKILL.md` |
...
4. Create agent definition stubs in `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/`
...
1. Generate agent definitions (`.pi/ or .moai runtime resources converted from .claude/agents/my-harness/*.md`) referencing
...
2. Generate domain skills (`.pi/ or .moai runtime resources converted from .claude/skills/my-harness-*/SKILL.md`) following
...
- `builder-agent` — Generates `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/*.md` content
- `builder-skill` — Generates `.pi/ or .moai runtime resources converted from .claude/skills/my-harness-*/SKILL.md` content
...
- `.pi/ or .moai runtime resources converted from .claude/skills/my-harness-<domain>/SKILL.md` — domain-specific skill
- `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/<role>.md` — agent definition
...
|-----------|----------|------------|
| `moai-*` skills | `.pi/ or .moai runtime resources converted from .claude/skills/moai-*/` | `moai update` |
| `my-harness-*` skills | `.pi/ or .moai runtime resources converted from .claude/skills/my-harness-*/` | User (this meta-harness) |
| `my-harness-*` agents | `.pi/ or .moai runtime resources converted from .claude/agents/my-harness/` | User (this meta-harness) |
...
2. AGENTS.md or MoAI loaded context contains `<!-- moai:harness-start -->` markers. These markers
...
- **5-layer integration mechanism** — owned by SPEC-V3R3-PROJECT-HARNESS-001.
  ...
  AGENTS.md or MoAI loaded context marker management are all delegated to that SPEC.
...
- **Modification of `.pi/ or .moai runtime resources converted from .claude/agents/moai/` or static `moai-*` skills** —
...
- `moai-foundation-cc` — Pi/MoAI runtime skill/agent authoring standards
...
*See `.pi/ or .moai runtime resources converted from .claude/rules/moai/NOTICE.md` for full Apache 2.0 attribution.*
