...
allowed-tools: Read, Grep, Glob, Bash(npm:*), Bash(npx:*), Bash(node:*), configured Pi web/fetch skill, configured Pi web/search skill, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
...
For official Chrome documentation, use configured Pi web/fetch skill with:
