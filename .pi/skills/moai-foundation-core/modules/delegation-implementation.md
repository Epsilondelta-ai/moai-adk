...
async def implement_feature_sequential(feature_description: str):
    ...
    spec_result = await moai_agent_invoke(
    ...
    # Phase 2: API Design
    api_result = await moai_agent_invoke(
    ...
    backend_result = await moai_agent_invoke(
        subagent_type="code-backend",
    ...
    frontend_result = await moai_agent_invoke(
    ...
    integration_result = await moai_agent_invoke(
    ...
    docs_result = await moai_agent_invoke(
