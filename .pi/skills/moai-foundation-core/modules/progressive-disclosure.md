...
# Validate skill
result = validator.validate_skill(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
