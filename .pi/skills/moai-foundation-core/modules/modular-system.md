...
Standard Structure:
```
.pi/ or .moai runtime resources converted from .claude/skills/skill-name/
...
.pi/ or .moai runtime resources converted from .claude/skills/skill-name/SKILL.md (Required, ≤500 lines):
...
decision = splitter.should_split(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core/SKILL.md")
...
if decision["split_needed"]:
 ...
 ".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core",
...
# Usage
organizer = SkillOrganizer(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
...
with open(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core/NAVIGATION.md", 'w') as f:
 f.write(navigation)
```
...
# Usage
discovery = ModuleDiscovery(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
...
Memory:
- .pi/ or .moai runtime resources converted from .claude/skills/ - Standard skill location
