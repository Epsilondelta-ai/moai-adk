...
Use Cases:
- Agent selection for moai_agent_invoke() delegation
...
Quick Access:
- Agent-First Mandate (moai_agent_invoke() only)
...
skill_path = Path(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core")
...
class ModuleSearch:
 ...
 modules_dir = Path(".pi/ or .moai runtime resources converted from .claude/skills/moai-foundation-core/modules")
 results = []
