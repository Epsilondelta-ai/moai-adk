...
const DEFAULT_HOOK_EVENTS: HookEventsConfig = {
  ...
  runtimeBridge: {
    connected: ["SessionStart", "PreCompact", "SessionEnd", "UserPromptSubmit", "PreToolUse", "PostToolUse", "PostToolUseFailure", "Stop"],
    statusOnly: [],
...
const DEFAULT_OUTPUT_STYLES: OutputStylesConfig = {
  ...
  styles: {
    ...
    r2d2: { source: "./generated/source/output-styles/moai/r2d2.md" },
    yoda: { source: "./generated/source/output-styles/moai/yoda.md" },
  },
  runtime: {
...
const DEFAULT_PACKAGE_MAP: PackageMapConfig = {
  ...
  primary: {
    ...
    quotaFooter: "@kmiyh/pi-codex-plan-limits",
  },
  fallbacks: {
  ...
  conflictPolicy: {
    footerQuota: "enable only one of @kmiyh/pi-codex-plan-limits, pi-chatgpt-limit, pi-codexbar",
