...
> ビルド済みバイナリは[Releases](https://github.com/Epsilondelta-ai/moai-adk/releases)ページからダウンロードできます。
...
- [Issues](https://github.com/Epsilondelta-ai/moai-adk/issues) -- バグ報告、機能リクエスト
